...
// import { CostSideNavMode } from '@/utils';
// import { DashboardUtilsMenu } from '@/components/dashboard-utils';

// export const CostSideNavPanel: React.FC<LayoutPanelComponent> = ({ layoutService }) => {
...
//         if (key === CostSideNavMode.SUMMARY) {
//             routing
