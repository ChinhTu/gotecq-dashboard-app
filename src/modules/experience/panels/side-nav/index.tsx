...
export const ExperienceSideNavPanel: React.FC<LayoutPanelComponent> = ({ layoutService }) => {
    ...
    const _handleClickMenuItem = (key: string) => {
        ...
        if (key === ExperienceSideNavMode.SUMMARY) {
            routing
        ...
        if (key === ExperienceSideNavMode.FAVORITE) {
            routing
                .setPrimary(ModulePanels.common.favoriteDashboard, {})
                .setSecondary('-', {});
        }

        if (key === ExperienceSideNavMode.WORK_ITEM) {
            routing
                .setPrimary(ModulePanels.common.workItemOverview, {})
                .setSecondary('-', {});
        }

        if (key === ExperienceSideNavMode.HELP) {
            routing
